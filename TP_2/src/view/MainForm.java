...
public class MainForm {
    ...
    public MainForm() {
        ...
        users.add(new Users(1, "John Doe", "1234567890", "1995-Feb-20", "123 Main Street"));
        users.add(new Users(2, "Jane Smith", "0987654321", "1990-Jul-15", "456 Oak Avenue"));
        users.add(new Users(3, "Bob Johnson", "5678901234", "1988-May-10", "789 Pine Lane"));
        users.add(new Users(4, "Alice Williams", "1122334455", "1992-Nov-30", "321 Elm Street"));
        users.add(new Users(5, "Charlie Brown", "5544332211", "1985-Apr-05", "987 Birch Road"));
        nextId = users.size() + 1;
